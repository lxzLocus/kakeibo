...
class EntryServiceImplTest {
    ...
    void addEntry_success() {
        ...
        Entry result = entryService.addEntry(1L, LocalDate.of(2026, 5, 1),
                new BigDecimal("1500"), 10L, 20L, EntryType.EXPENSE, "テストメモ");
    ...
    void addEntry_withoutStore() {
        ...
        Entry result = entryService.addEntry(1L, LocalDate.of(2026, 5, 1),
                new BigDecimal("500"), 10L, null, EntryType.INCOME, null);
    ...
    void addEntry_userNotFound() {
        ...
        assertThatThrownBy(() ->
                entryService.addEntry(999L, LocalDate.now(), BigDecimal.TEN, 10L, null, EntryType.EXPENSE, null))
    ...
    void addEntry_categoryBelongsToOtherUser() {
        ...
        assertThatThrownBy(() ->
                entryService.addEntry(1L, LocalDate.now(), BigDecimal.TEN, 10L, null, EntryType.EXPENSE, null))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void addEntry_storeBelongsToOtherUser() {
        ...
        assertThatThrownBy(() ->
                entryService.addEntry(1L, LocalDate.now(), BigDecimal.TEN, 10L, 20L, EntryType.EXPENSE, null))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void updateEntry_success() {
        ...
        Entry result = entryService.updateEntry(1L, 100L, LocalDate.of(2026, 6, 1),
                new BigDecimal("2000"), 10L, null, EntryType.EXPENSE, "更新メモ");
    ...
    void updateEntry_permissionDenied() {
        ...
        assertThatThrownBy(() ->
                entryService.updateEntry(1L, 100L, LocalDate.now(), BigDecimal.TEN, 10L, null, EntryType.EXPENSE, null))
                .isInstanceOf(IllegalArgumentException.class)
